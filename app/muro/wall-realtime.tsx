...
function WallImageCounter({ count }: { count: number }) {
  return (
    <div className="pointer-events-none absolute left-5 top-36 z-50 bg-[#0A0A0A]/70 px-4 py-3 font-mono text-[#00ACA8] shadow-[6px_6px_0_#0A0A0A] backdrop-blur-sm sm:left-8 sm:top-48 sm:px-5 sm:py-4">
      ...
      <>
        ...
        <div className="relative z-10 flex min-h-dvh items-center justify-center p-8 text-center">
          <div className="max-w-md space-y-3">
            <p className="text-3xl font-black text-[#FF323C]">Aún no hay cards en el muro</p>
      ...
      <section className="absolute inset-0">
        {images.map((image, index) => (
          <article
            ...
            className="absolute w-[38vw] min-w-[132px] max-w-[240px] overflow-hidden rounded-[1.15rem] bg-[#0A0A0A] shadow-[0_24px_70px_rgba(0,0,0,0.6)] transition duration-300 hover:z-50 hover:scale-110 sm:w-[24vw] md:w-[220px]"
          >
